...
# Remain checkout
- [ ] [ICLR 2021] BOWTIE NETWORKS: GENERATIVE MODELING FOR JOINT FEW-SHOT RECOGNITION AND NOVEL-VIEW SYNTHESIS
- [ ] [ICLR 2021] BOIL: TOWARDS REPRESENTATION CHANGE FOR FEW-SHOT LEARNING
- [ ] [ICLR 2021] BAYESIAN FEW-SHOT CLASSIFICATION WITH ONE-VS-EACH PO ́ LYA-GAMMA AUGMENTED GAUSSIAN PROCESSES
- [ ] [ICLR 2021] CONSTELLATION NETS FOR FEW-SHOT LEARNING
- [ ] [ICLR 2021] METANORM: LEARNING TO NORMALIZE FEW-SHOT BATCHES ACROSS DOMAINS
- [ ] [ICLR 2021] DISENTANGLING 3D PROTOTYPICAL NETWORKS FOR FEW-SHOT CONCEPT LEARNING
- [ ] [ICLR 2021] MELR: META-LEARNING VIA MODELING EPISODE- LEVEL RELATIONSHIPS FOR FEW-SHOT LEARNING
- [ ] [ICLR 2021] REPURPOSING PRETRAINED MODELS FOR ROBUST OUT-OF-DOMAIN FEW-SHOT LEARNING
- [ ] [ICLR 2021] FEW-SHOT BAYESIAN OPTIMIZATION WITH DEEP KERNEL SURROGATES
- [ ] [ICLR 2021] TOWARDS FASTER AND STABILIZED GAN TRAINING FOR HIGH-FIDELITY FEW-SHOT IMAGE SYNTHESIS
...
- [ ] [ICLR 2021] FEW-SHOT LEARNING VIA LEARNING THE REPRESENTATION, PROVABLY
- [ ] [ICLR 2021] IEPT: INSTANCE-LEVEL AND EPISODE-LEVEL PRE- TEXT TASKS FOR FEW-SHOT LEARNING
